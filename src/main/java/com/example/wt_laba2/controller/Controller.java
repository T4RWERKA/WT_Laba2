...
import com.example.wt_laba2.controller.logic.CommandHelper;
import com.example.wt_laba2.controller.logic.ICommand;
import com.example.wt_laba2.controller.logic.JSPHelper;
...
import com.example.wt_laba2.controller.logic.*;
...
//            logger.error("ERROR: Page exception in Controller " + e.toString());
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        String so = req.getParameter(RequestCommandName.PRODUCT_NAME);
        String result = null;
